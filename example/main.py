...
from pgui.core.input_manager import INPUT_MANAGER
from pgui.core.screen import Screen, Viewport
from pgui.event.handler import MouseHandler
from pgui.view import ButtonView, InputBoxView, CheckBoxView
...
def on_mouse_up(_view: ButtonView, key: MouseButton, is_hit: bool) -> bool:
    if not is_hit:
        return False
...
input_box.text_view.font = "example/asset/gg sans Medium.ttf"
